      ...
      <div class="container mx-auto px-4">
        ...
        <div class="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
            ...
            <div class="lg:flex lg:items-start">
              <div class="lg:order-2 lg:ml-5">
                <div class="max-w-xl overflow-hidden rounded-lg">
                  <img class="h-full w-full max-w-full object-cover" src="https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/452146/item/goods_09_452146.jpg?width=494" alt="" />
                </div>
              </div>
          ...
          <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2">
            ...
            <h2 class="mt-8 text-base text-gray-900">T-shirt size</h2>
          ...
          <div class="lg:col-span-3">
            ...
            <div class="mt-8 flow-root sm:mt-12">
              <h1 class="text-3xl font-bold">T-shirt</h1>
              <p class="mt-4">This shirt is made of cotton combad 32 S and is comfortable to wear</p>               
            </div>
          </div>
        </div>
      </div>
